describe('Busqueda de vuelo en Wingo', () => {
  beforeEach(() => {
    ...
    it('Buscar un vuelo Bogotá a Cali ida y regreso para dos adultos con fecha ida 27/04/2023 y vuelta 31/05/2023', () => {
      ...
      cy.get('#inputOutboundDate > .cont-calendar > .cont-months > .date-picker-wrapper > :nth-child(1) > :nth-child(1) > .month-wrapper > .month1 > tbody > :nth-child(5) > :nth-child(4) > .day').click();
      cy.get('.info-select.info-select-start').should('contain', '27/04/2023');//Verificar que se selecciono la fecha 29/04/2023
